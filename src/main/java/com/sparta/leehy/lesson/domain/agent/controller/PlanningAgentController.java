...
import com.sparta.leehy.lesson.domain.agent.dto.request.AdaptivePlanningRequest;
...
import com.sparta.leehy.lesson.domain.agent.dto.response.ExecutionResult;
import com.sparta.leehy.lesson.domain.agent.service.PlanningAgentService;
...
public class PlanningAgentController {
    ...
    private final PlanningAgentService planningAgent;
